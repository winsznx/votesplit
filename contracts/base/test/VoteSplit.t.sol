...
import "../src/VoteSplit.sol";

contract UvotesplitTest is Test {
    Uvotesplit public registry;
    ...
    function testCannotRegisterDuplicateName() public {
        ...
        vm.prank(user2);
        vm.expectRevert(Uvotesplit.NameAlreadyRegistered.selector);
        registry.registerName("alice");
    }
    ...
    function testCannotTransferUnownedName() public {
        ...
        vm.prank(user2);
        vm.expectRevert(Uvotesplit.NotNameOwner.selector);
        registry.transferName("alice", user2);
    }
    ...
    function testInvalidNameLength() public {
        vm.prank(user1);
        vm.expectRevert(Uvotesplit.InvalidName.selector);
